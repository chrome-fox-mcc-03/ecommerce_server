    ...
    describe('Error /product', () => {
        test('[product name null] sending error with status code 400 ', (done) => {
            ...
            .end((err, res) => {
                ...
                expect(res.body.errors[0]).toBe('product name cannot be null')
        ...
        test('[negative price] sending error with status code 400 ', (done) => {
            ...
            .end((err, res) => {
                ...
                expect(res.body).toHaveProperty('message', expect.any(String))
                expect(res.body).toHaveProperty('errors', expect.any(Array))
                expect(res.body.errors[0]).toBe('price cannot be negative')
                expect(res.body.errors.length).toBe(1)
                done()
            })
        })
        ...
        test('[negative stock] sending error with status code 400 ', (done) => {
            ...
            .end((err, res) => {
                ...
                expect(res.body).toHaveProperty('message', expect.any(String))
                expect(res.body).toHaveProperty('errors', expect.any(Array))
                expect(res.body.errors[0]).toBe('stock cannot be negative')
                expect(res.body.errors.length).toBe(1)
                done()
            })
        })
        ...
        test('[not numeric price] sending error with status code 400 ', (done) => {
            ...
            .end((err, res) => {
                ...
                expect(res.body).toHaveProperty('message', expect.any(String))
                expect(res.body).toHaveProperty('errors', expect.any(Array))
                expect(res.body.errors[0]).toBe('price should be number')
                expect(res.body.errors.length).toBe(1)
                done()
            })
        })
        ...
        test('[not numeric stock] sending error with status code 400 ', (done) => {
            ...
            .end((err, res) => {
                ...
                expect(res.body).toHaveProperty('message', expect.any(String))
                expect(res.body).toHaveProperty('errors', expect.any(Array))
                expect(res.body.errors[0]).toBe('stock should be number')
                expect(res.body.errors.length).toBe(1)
                done()
            })
        })
        ...
        test('[null stock] sending error with status code 400 ', (done) => {
            ...
            .end((err, res) => {
                ...
                expect(res.body).toHaveProperty('message', expect.any(String))
                expect(res.body).toHaveProperty('errors', expect.any(Array))
                expect(res.body.errors[0]).toBe('stock cannot be null')
                expect(res.body.errors.length).toBe(1)
                done()
            })
        })
        ...
        test('[null price] sending error with status code 400 ', (done) => {
            ...
            .end((err, res) => {
                ...
                expect(res.body).toHaveProperty('message', expect.any(String))
                expect(res.body).toHaveProperty('errors', expect.any(Array))
                expect(res.body.errors[0]).toBe('price cannot be null')
                expect(res.body.errors.length).toBe(1)
                done()
            })
        })
